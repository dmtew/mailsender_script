...
for _id_ in json_["data"]["leads"]:
    ...
    title = 'Обращение от [' + json_["data"]["leads"][_id_]["client"]["name"] + ']'
    ...
    if "310277" in json_["data"]["leads"][_id_]["form_data"]:
        ...
        mes = 'Мой номер ' + phone + '\n'+ "Хочу получить консультацию " + str(json_["data"]["leads"][_id_]["form_data"]["900782"]["value"]) + str(json_["data"]["leads"][_id_]["form_data"]["986663"]["value"])
